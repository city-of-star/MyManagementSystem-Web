 ...
 * 获取权限树（全量）
 */
export function getPermissionTree(payload: Partial<PermissionPageQuery> = {}): Promise<PermissionTreeVo[]> {
  return httpPost<PermissionTreeVo[]>(SERVICE.USERCENTER, '/permission/tree', payload)
}
